...
# india is not always on 2nd item so you need to use find elements (ui-menu-item)
...
#you cannot use .text method since the value is not pre built when the site is loaded for the first time
#value "india" is handle thru script dynamically so use get.attribute
# WRONG -> print(driver.find_element(By.CSS_SELECTOR, "#autosuggest").text
# print(driver.find_element(By.CSS_SELECTOR, "#autosuggest").get_attribute("value"))

message = (driver.find_element(By.CSS_SELECTOR, "#autosuggest").get_attribute("value"))
print(message)
assert message == "India"
