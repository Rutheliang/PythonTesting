...
# dropdown.select_by_value() -> value attribute if its declare or define
# sample value attribute -> <option value="teach">teacher</option> -> dropdown.select_by_value(teach)
